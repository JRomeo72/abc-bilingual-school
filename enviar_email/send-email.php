...
if ($name === ''){
  print json_encode(array('message' => 'The name field cannot be empty.', 'code' => 0));
  exit();
}
if ($email === ''){
  print json_encode(array('message' => 'The Email field cannot be empty.', 'code' => 0));
  exit();
} else {
...
if ($subject === ''){
  print json_encode(array('message' => 'The subject field cannot be empty.', 'code' => 0));
  exit();
}
if ($message === ''){
  print json_encode(array('message' => 'The message field cannot be empty.', 'code' => 0));
  exit();
}
